...
class ShippingForm(forms.ModelForm):
	...
	class Meta:
		...
		# below 'user' taken from models.py to class ShippingAddress(models.Model):
		# below 'user' is a foreignkey we'll need it beut we dont want it to pop up on the form
		exclude = ['user',]

# no need to save and store credit card. send it to stripe
